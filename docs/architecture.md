...
flowchart TB
  ...
  Gateway --> Channel
  Cron -->|"Mon–Sat 19:00 daily, Sun 19:00 recap, 10:00 connect, Mon 00:00"| Channel
```
...
node-cron  -- Mon 00:00 reset, 10:00 connect nudge, Mon–Sat 19:00 daily, Sun 19:00 recap -->  SQLite / crew channel
```
